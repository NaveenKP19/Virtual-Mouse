...
class GestureControlPanel:
    ...
    def run(self):
        ...
        self.create_r_gesture_label(
            right_hand_commands_frame, "imgs/move1.png", "Move", std_label_w
        )

        self.create_r_gesture_label(
            right_hand_commands_frame, "imgs/Lclick.png", "Left Click", std_label_w
        )

        self.create_r_gesture_label(
            right_hand_commands_frame, "imgs/Rclick.png", "Right click", std_label_w
        )
